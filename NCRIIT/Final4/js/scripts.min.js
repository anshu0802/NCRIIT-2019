! function(e, t) {
    ...
    var p = function(n) {
        var e, p, b, i, o, h, f, g, w, u, l, T, C, a, E, m, s, c, v, k = "sizzle" + 1 * new Date,
            y = n.document,
            S = 0,
            r = 0,
            d = ae(),
        ...
        try {
            L.apply(t = $.call(y.childNodes), y.childNodes), t[y.childNodes.length].nodeType
        } catch (n) {
            L = {
            ...
            if (!r && ((t ? t.ownerDocument || t : y) !== C && T(t), t = t || C, E)) {
                if (11 !== d && (u = J.exec(e)))
                    if (o = u[1]) {
                        ...
                        if ((o = u[3]) && p.getElementsByClassName && t.getElementsByClassName) return L.apply(n, t.getElementsByClassName(o)), n
        ...
        for (e in p = ie.support = {}, o = ie.isXML = function(e) {
                ...
                return r !== C && 9 === r.nodeType && r.documentElement && (a = (C = r).documentElement, E = !o(C), y !== C && (n = C.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", re, !1) : n.attachEvent && n.attachEvent("onunload", re)), p.attributes = ue(function(e) {
                    return e.className = "i", !e.getAttribute("className")
                }), p.getElementsByTagName = ue(function(e) {
                    return e.appendChild(C.createComment("")), !e.getElementsByTagName("*").length
                }), p.getElementsByClassName = Q.test(C.getElementsByClassName), p.getById = ue(function(e) {
                ...
                }, s = [], m = [], (p.qsa = Q.test(C.querySelectorAll)) && (ue(function(e) {
                ...
                })), (p.matchesSelector = Q.test(c = a.matches || a.webkitMatchesSelector || a.mozMatchesSelector || a.oMatchesSelector || a.msMatchesSelector)) && ue(function(e) {
                    p.disconnectedMatch = c.call(e, "*"), c.call(e, "[s!='']:x"), s.push("!=", R)
                    ...
                    return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !p.sortDetached && t.compareDocumentPosition(e) === n ? e === C || e.ownerDocument === y && v(y, e) ? -1 : t === C || t.ownerDocument === y && v(y, t) ? 1 : u ? H(u, e) - H(u, t) : 0 : 4 & n ? -1 : 1)
                } : function(e, t) {
                    if (e === t) return l = !0, 0;
                    var n, r = 0,
                        o = e.parentNode,
                ...
                if ((e.ownerDocument || e) !== C && T(e), t = t.replace(U, "='$1']"), p.matchesSelector && E && !D[t + " "] && (!s || !s.test(t)) && (!m || !m.test(t))) try {
                    var n = c.call(e, t);
                ...
                var t, n = [],
                    r = 0,
                    o = 0;
                if (l = !p.detectDuplicates, u = !p.sortStable && e.slice(0), e.sort(N), l) {
                ...
                preFilter: {
                    ...
                    PSEUDO: function(e) {
                        var t, n = !e[6] && e[2];
                        return V.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && z.test(n) && (t = h(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function(e) {
                        ...
                        return 1 === g && 0 === m ? function(e) {
                            ...
                            if (c) {
                                ...
                                if (u = [y ? c.firstChild : c.lastChild], y && d) {
                                    for (p = (s = (r = (o = (i = (a = c)[k] || (a[k] = {}))[a.uniqueID] || (i[a.uniqueID] = {}))[h] || [])[0] === S && r[1]) && r[2], a = s && c.childNodes[s]; a = ++s && a && a[l] || (p = s = 0) || u.pop();)
                                        if (1 === a.nodeType && ++p && a === e) {
                                            o[h] = [S, s, p];
                                            break
                                        }
                                } else if (d && (p = s = (r = (o = (i = (a = e)[k] || (a[k] = {}))[a.uniqueID] || (i[a.uniqueID] = {}))[h] || [])[0] === S && r[1]), !1 === p)
                                    for (;
                                        (a = ++s && a && a[l] || (p = s = 0) || u.pop()) && ((x ? a.nodeName.toLowerCase() !== f : 1 !== a.nodeType) || !++p || (d && ((o = (i = a[k] || (a[k] = {}))[a.uniqueID] || (i[a.uniqueID] = {}))[h] = [S, p]), a !== e)););
                    ...
                    for (; e = e[u];)
                        if (1 === e.nodeType || f)
                            if (o = (i = e[k] || (e[k] = {}))[e.uniqueID] || (i[e.uniqueID] = {}), l && l === e.nodeName.toLowerCase()) e = e[u] || e;
                                ...
                                if ((r = o[c]) && r[0] === S && r[1] === d) return a[2] = r[2];
            ...
            return m && !m[k] && (m = we(m)), v && !v[k] && (v = we(v, e)), se(function(e, t, n, r) {
                ...
                if (e) {
                    if (v || p) {
                        ...
                        for (i = d.length; i--;)(a = d[i]) && -1 < (o = v ? H(e, a) : s[i]) && (e[o] = !(t[o] = a))
                    }
                } else d = be(d === t ? d.splice(l, d.length) : d), v ? v(null, t, d, r) : L.apply(t, d)
            })
        }
        ...
        return me.prototype = b.filters = b.pseudos, b.setFilters = new me, h = ie.tokenize = function(e, t) {
            ...
            for (a = e, s = [], u = b.preFilter; a;) {
                for (i in n && !(r = F.exec(a)) || (r && (a = a.slice(r[0].length) || a), s.push(o = [])), n = !1, (r = _.exec(a)) && (n = r.shift(), o.push({
                        value: n,
                        type: r[0].replace(W, " ")
            ...
            if (!a) {
                ...
                (a = D(e, (m = i, v = o, y = 0 < v.length, x = 0 < m.length, r = function(e, t, n, r, o) {
                    var i, a, s, u = 0,
                        l = "0",
                        c = e && [],
                        f = [],
                    ...
                    if (u += l, y && l !== u) {
                        ...
                        L.apply(r, f), o && !e && 0 < f.length && 1 < u + v.length && ie.uniqueSort(r)
                    }
                    return o && (S = h, w = d), c
                }, y ? se(r) : r))).selector = e
            }
            ...
            if (n = n || [], 1 === c.length) {
                ...
                for (o = V.needsContext.test(e) ? 0 : i.length; o-- && (a = i[o], !b.relative[s = a.type]);)
                    if ((u = b.find[s]) && (r = u(a.matches[0].replace(Z, ee), K.test(i[0].type) && ge(t.parentNode) || t))) {
                        if (i.splice(o, 1), !(e = r.length && ve(i))) return L.apply(n, r), n;
                        break
                    }
            }
            return (l || f(e, c))(r, t, !E, n, !t || K.test(e) && ge(t.parentNode) || t), n
        }, p.sortStable = k.split("").sort(N).join("") === k, p.detectDuplicates = !!l, T(), p.sortDetached = ue(function(e) {
    ...
    k.fn.extend({
        ...
        k.fn[r] = function(e, t) {
            ...
            return "Until" !== r.slice(-5) && (t = e), t && "string" == typeof t && (n = k.filter(t, n)), 1 < this.length && ($[r] || k.uniqueSort(n), L.test(r) && n.reverse()), this.pushStack(n)
        }
    });
    var O = /[^\x20\t\r\n\f]+/g;
    ...
    k.Callbacks = function(r) {
                ...
                a = {
                    ...
                    then: function(t, n, r) {
                                ...
                                var n = this,
                                    ...
                                    e = function() {
                                        ...
                                        if (!(o < u)) {
                                            ...
                                            t = e && ("object" == typeof e || "function" == typeof e) && e.then, y(t) ? s ? t.call(e, l(u, i, P, s), l(u, i, I, s)) : (u++, t.call(e, l(u, i, P, s), l(u, i, I, s), l(u, i, P, i.notifyWith))) : (a !== P && (n = void 0, r = [e]), (s || i.resolveWith)(n, r))
                                        }
                                    },
                                    t = s ? e : function() {
                                        try {
                                            ...
                                            k.Deferred.exceptionHook && k.Deferred.exceptionHook(e, t.stackTrace), u <= o + 1 && (a !== I && (n = void 0, r = [e]), i.rejectWith(n, r))
                                        }
                                    };
                        ...
                        return k.Deferred(function(e) {
                            i[0][3].add(l(0, e, y(r) ? r : P, e.notifyWith)), i[1][3].add(l(0, e, y(t) ? t : P)), i[2][3].add(l(0, e, y(n) ? n : I))
                        }).promise()
                    },
                    promise: function(e) {
        ...
        when: function(e) {
            ...
            if (n <= 1 && (M(e, i.done(a(t)).resolve, i.reject, !n), "pending" === i.state() || y(o[t] && o[t].then))) return i.then();
            for (; t--;) M(o[t], a(t), i.reject);
            return i.promise()
        }
    });
    ...
    function W() {
        E.removeEventListener("DOMContentLoaded", W), C.removeEventListener("load", W), k.ready()
    }
    ...
    }), k.ready.then = B.then, "complete" === E.readyState || "loading" !== E.readyState && !E.documentElement.doScroll ? C.setTimeout(k.ready) : (E.addEventListener("DOMContentLoaded", W), C.addEventListener("load", W));
    ...
    function se(e, t) {
        for (var n, r, o = [], i = 0, a = e.length; i < a; i++)(r = e[i]).style && (n = r.style.display, t ? ("none" === n && (o[i] = G.get(r, "display") || null, o[i] || (r.style.display = "")), "" === r.style.display && re(r) && (o[i] = (f = l = u = void 0, l = (s = r).ownerDocument, c = s.nodeName, (f = ae[c]) || (u = l.body.appendChild(l.createElement(c)), f = k.css(u, "display"), u.parentNode.removeChild(u), "none" === f && (f = "block"), ae[c] = f)))) : "none" !== n && (o[i] = "none", G.set(r, "display", n)));
        var s, u, l, c, f;
    ...
    function ve(e, t, n, r, o) {
        ...
        for (f.textContent = "", p = 0; i = d[p++];)
            ...
            else if (l = k.contains(i.ownerDocument, i), a = de(f.appendChild(i), "script"), l && pe(a), n)
    ...
    k.event = {
        ...
        add: function(t, e, n, r, o) {
            var i, a, s, u, l, c, f, d, p, h, g, m = G.get(t);
            if (m)
                for (n.handler && (n = (i = n).handler, o = i.selector), o && k.find.matchesSelector(ye, o), n.guid || (n.guid = k.guid++), (u = m.events) || (u = m.events = {}), (a = m.handle) || (a = m.handle = function(e) {
                        return void 0 !== k && k.event.triggered !== e.type ? k.event.dispatch.apply(t, arguments) : void 0
                    }), l = (e = (e || "").match(O) || [""]).length; l--;) p = g = (s = we.exec(e[l]) || [])[1], h = (s[2] || "").split(".").sort(), p && (f = k.event.special[p] || {}, p = (o ? f.delegateType : f.bindType) || p, f = k.event.special[p] || {}, c = k.extend({
                    type: p,
                    origType: g,
                    data: r,
                    handler: n,
        ...
        remove: function(e, t, n, r, o) {
            var i, a, s, u, l, c, f, d, p, h, g, m = G.hasData(e) && G.get(e);
            if (m && (u = m.events)) {
    ...
    function He(n, r, o, i) {
        ...
        if (h || 1 < f && "string" == typeof p && !v.checkClone && Ne.test(p)) return n.each(function(e) {
            var t = n.eq(e);
            h && (r[0] = p.call(this, e, t.html())), He(t, r, o, i)
        });
        if (f && (t = (e = ve(r, n[0].ownerDocument, !1, n, i)).firstChild, 1 === e.childNodes.length && (e = t), t || i)) {
            for (s = (a = k.map(de(e, "script"), qe)).length; c < f; c++) u = e, c !== d && (u = k.clone(u, !0, !0), s && k.merge(a, de(u, "script"))), o.call(n[c], u, c);
            if (s)
                for (l = a[a.length - 1].ownerDocument, k.map(a, Le), c = 0; c < s; c++) u = a[c], ce.test(u.type || "") && !G.access(u, "globalEval") && k.contains(l, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? k._evalUrl && k._evalUrl(u.src) : b(u.textContent.replace(Ae, ""), l, u))
        }
        return n
    }

    function Oe(e, t, n) {
        for (var r, o = t ? k.filter(t, e) : e, i = 0; null != (r = o[i]); i++) n || 1 !== r.nodeType || k.cleanData(de(r)), r.parentNode && (n && k.contains(r.ownerDocument, r) && pe(de(r, "script")), r.parentNode.removeChild(r));
        return e
    }
    k.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (t)
                if (n)
                    for (i = i || de(e), a = a || de(c), r = 0, o = i.length; r < o; r++) $e(i[r], a[r]);
                else $e(e, c);
    ...
    function Re(e, t, n) {
        ...
        return (n = n || Ie(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || k.contains(e.ownerDocument, e) || (a = k.style(e, t)), !v.pixelBoxStyles() && Pe.test(a) && Me.test(t) && (r = s.width, o = s.minWidth, i = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = o, s.maxWidth = i)), void 0 !== a ? a + "" : a
    }
    ...
    function Qe(e, t, n) {
        ...
        return a = a && (v.boxSizingReliable() || o === e.style[t]), ("auto" === o || !parseFloat(o) && "inline" === k.css(e, "display", !1, r)) && (o = e["offset" + t[0].toUpperCase() + t.slice(1)], a = !0), (o = parseFloat(o) || 0) + Ge(e, t, n || (i ? "border" : "content"), a, r, o) + "px"
    }
    ...
    k.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" == (i = typeof n) && (o = te.exec(n)) && o[1] && (n = ie(e, t, o), i = "number"), null != n && n == n && ("number" === i && (n += o && o[3] || (k.cssNumber[s] ? "" : "px")), v.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u ? l.setProperty(t, n) : l[t] = n))
            }
        },
        css: function(e, t, n, r) {
            var o, i, a, s = X(t);
            return Fe.test(t) || (t = Ve(s)), (a = k.cssHooks[t] || k.cssHooks[s]) && "get" in a && (o = a.get(e, !0, n)), void 0 === o && (o = Re(e, t, r)), "normal" === o && t in Ue && (o = Ue[t]), "" === n || n ? (i = parseFloat(o), !0 === n || isFinite(i) ? i || 0 : o) : o
        }
    }), k.each(["height", "width"], function(e, s) {
        k.cssHooks[s] = {
            get: function(e, t, n) {
                if (t) return !We.test(k.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Qe(e, s, n) : oe(e, _e, function() {
                    return Qe(e, s, n)
                })
            },
            set: function(e, t, n) {
                var r, o = Ie(e),
                    ...
                    a = n && Ge(e, s, n, i, o);
                return i && v.scrollboxSize() === o.position && (a -= Math.ceil(e["offset" + s[0].toUpperCase() + s.slice(1)] - parseFloat(o[s]) - Ge(e, s, "border", !1, o) - .5)), a && (r = te.exec(t)) && "px" !== (r[3] || "px") && (e.style[s] = t, t = k.css(e, s)), Ye(0, t, a)
            }
        }
        ...
        css: function(e, t) {
            return F(this, function(e, t, n) {
                var r, o, i = {},
                    a = 0;
                if (Array.isArray(t)) {
                    for (r = Ie(e), o = t.length; a < o; a++) i[t[a]] = k.css(e, t[a], !1, r);
                    return i
                }
    ...
    function ot() {
        Ze && (!1 === E.hidden && C.requestAnimationFrame ? C.requestAnimationFrame(ot) : C.setTimeout(ot, k.fx.interval), k.fx.tick())
    }
    ...
    k.Animation = k.extend(ut, {
        ...
        tweener: function(e, t) {
            for (var n, r = 0, o = (e = y(e) ? (t = e, ["*"]) : e.match(O)).length; r < o; r++) n = e[r], ut.tweeners[n] = ut.tweeners[n] || [], ut.tweeners[n].unshift(t)
        },
        prefilters: [function(e, t, n) {
            ...
            for (r in n.queue || (null == (a = k._queueHooks(e, "fx")).unqueued && (a.unqueued = 0, s = a.empty.fire, a.empty.fire = function() {
                ...
                for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (l = m && m.display) && (l = G.get(e, "display")), "none" === (c = k.css(e, "display")) && (l ? c = l : (se([e], !0), l = e.style.display || l, c = k.css(e, "display"), se([e]))), ("inline" === c || "inline-block" === c && null != l) && "none" === k.css(e, "float") && (u || (d.done(function() {
                        h.display = l
                    }), null == l && (c = h.display, l = "none" === c ? "" : c)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", d.always(function() {
                        h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
                    })), u = !1, p) u || (m ? "hidden" in m && (g = m.hidden) : m = G.access(e, "fxshow", {
                    display: l
                }), i && (m.hidden = !g), g && se([e], !0), d.done(function() {
                    for (r in g || se([e]), G.remove(e, "fxshow"), p) k.style(e, r, p[r])
                })), u = st(g ? m[r] : 0, r, d), r in m || (m[r] = u.start, g && (u.end = u.start, u.start = 0))
        }],
    ...
    k.extend(k.event, {
        trigger: function(e, t, n, r) {
            ...
            if (i = f = a = n = n || E, 3 !== n.nodeType && 8 !== n.nodeType && !vt.test(p + k.event.triggered) && (-1 < p.indexOf(".") && (p = (h = p.split(".")).shift(), h.sort()), u = p.indexOf(":") < 0 && "on" + p, (e = e[k.expando] ? e : new k.Event(p, "object" == typeof e && e)).isTrigger = r ? 2 : 3, e.namespace = h.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : k.makeArray(t, [e]), c = k.event.special[p] || {}, r || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                if (!r && !c.noBubble && !x(n)) {
                    for (s = c.delegateType || p, vt.test(s + p) || (i = i.parentNode); i; i = i.parentNode) d.push(i), a = i;
                ...
                return e.type = p, r || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(d.pop(), t) || !V(n) || u && y(n[p]) && !x(n) && ((a = n[u]) && (n[u] = null), k.event.triggered = p, e.isPropagationStopped() && f.addEventListener(p, yt), n[p](), e.isPropagationStopped() && f.removeEventListener(p, yt), k.event.triggered = void 0, a && (n[u] = a)), e.result
            }
        },
    ...
    Pt.href = xt.href, k.extend({
        ...
        ajax: function(e, t) {
            ...
            var c, f, d, n, p, r, h, g, o, i, m = k.ajaxSetup({}, t),
                v = m.context || m,
            ...
            if (x.promise(T), m.url = ((e || m.url || xt.href) + "").replace(Lt, xt.protocol + "//"), m.type = t.method || t.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(O) || [""], null == m.crossDomain) {
                r = E.createElement("a");
                try {
            ...
            if (m.data && m.processData && "string" != typeof m.data && (m.data = k.param(m.data, m.traditional)), Mt($t, m, t, T), h) return T;
            for (o in (g = k.event && m.global) && 0 == k.active++ && k.event.trigger("ajaxStart"), m.type = m.type.toUpperCase(), m.hasContent = !qt.test(m.type), f = m.url.replace(Nt, ""), m.hasContent ? m.data && m.processData && 0 === (m.contentType || "").indexOf("application/x-www-form-urlencoded") && (m.data = m.data.replace(Dt, "+")) : (i = m.url.slice(f.length), m.data && (m.processData || "string" == typeof m.data) && (f += (wt.test(f) ? "&" : "?") + m.data, delete m.data), !1 === m.cache && (f = f.replace(At, "$1"), i = (wt.test(f) ? "&" : "?") + "_=" + bt++ + i), m.url = f + i), m.ifModified && (k.lastModified[f] && T.setRequestHeader("If-Modified-Since", k.lastModified[f]), k.etag[f] && T.setRequestHeader("If-None-Match", k.etag[f])), (m.data && m.hasContent && !1 !== m.contentType || t.contentType) && T.setRequestHeader("Content-Type", m.contentType), T.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + Ot + "; q=0.01" : "") : m.accepts["*"]), m.headers) T.setRequestHeader(o, m.headers[o]);
            if (m.beforeSend && (!1 === m.beforeSend.call(v, T, m) || h)) return T.abort();
            if (u = "abort", b.add(m.complete), T.done(m.success), T.fail(m.error), c = Mt(Ht, m, t, T)) {
    ...
    v.cors = !!Wt && "withCredentials" in Wt, v.ajax = Wt = !!Wt, k.ajaxTransport(function(o) {
        var i, a;
        if (v.cors || Wt && !o.crossDomain) return {
            send: function(e, t) {
                var n, r = o.xhr();
                ...
                i = function(e) {
                    return function() {
                        i && (i = a = r.onload = r.onerror = r.onabort = r.ontimeout = r.onreadystatechange = null, "abort" === e ? r.abort() : "error" === e ? "number" != typeof r.status ? t(0, "error") : t(r.status, r.statusText) : t(Bt[r.status] || r.status, r.statusText, "text" !== (r.responseType || "text") || "string" != typeof r.responseText ? {
                            binary: r.response
                        } : {
                            text: r.responseText
    ...
    k.ajaxSetup({
        ...
        if (a || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = y(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Ut, "$1" + r) : !1 !== e.jsonp && (e.url += (wt.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {
            ...
            void 0 === o ? k(C).removeProp(r) : C[r] = o, e[r] && (e.jsonpCallback = t.jsonpCallback, _t.push(r)), i && y(o) && o(i[0]), i = o = void 0
        }), "script"
    }), v.createHTMLDocument = ((Ft = E.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Ft.childNodes.length), k.parseHTML = function(e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (v.createHTMLDocument ? ((r = (t = E.implementation.createHTMLDocument("")).createElement("base")).href = E.location.href, t.head.appendChild(r)) : t = E), i = !n && [], (o = N.exec(e)) ? [t.createElement(o[1])] : (o = ve([e], t, i), i && i.length && k(i).remove(), k.merge([], o.childNodes)));
        var r, o, i
    }, k.fn.load = function(e, t, n) {
        var r, o, i, a = this,
            s = e.indexOf(" ");
        return -1 < s && (r = pt(e.slice(s)), e = e.slice(0, s)), y(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), 0 < a.length && k.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
        ...
        k.cssHooks[n] = Be(v.pixelPosition, function(e, t) {
            if (t) return t = Re(e, n), Pe.test(t) ? k(e).position()[n] + "px" : t
        })
    }), k.each({
        Height: "height",
        Width: "width"
    ...
    }, k.isArray = Array.isArray, k.parseJSON = JSON.parse, k.nodeName = D, k.isFunction = y, k.isWindow = x, k.camelCase = X, k.type = w, k.now = Date.now, k.isNumeric = function(e) {
        var t = k.type(e);
    ...
    window.addEventListener("load", function() {
            setTimeout(function() {
                e.className += " fade", e.style.display = "none"
            }, 4e3)
        }), $(".tab").on("click", function() {
            $(".tab, .panel").removeClass("active"), $(this).add("#" + $(this).attr("id").replace(/\s*tab\s*/, "panel")).addClass("active")
        }), $(".tab-sale").on("click", function() {
            $(".tab-sale, .panel-sale").removeClass("active"), $(this).add("#" + $(this).attr("id").replace(/\s*tab\s*/, "panel")).addClass("active")
        }), $(".tab-faq").on("click", function() {
            $(".tab-faq, .panel-faq").removeClass("active"), $(this).add("#" + $(this).attr("id").replace(/\s*tab\s*/, "panel")).addClass("active")
        }),
        function(e, a) {
            var t = document.getElementById(e),
                s = t.querySelector(".days"),
                u = t.querySelector(".hours"),
                l = t.querySelector(".minutes"),
                c = t.querySelector(".seconds");

            function n() {
                var e, t, n, r, o, i = (e = a, t = Date.parse(e) - Date.parse(new Date), n = Math.floor(t / 1e3 % 60), r = Math.floor(t / 1e3 / 60 % 60), o = Math.floor(t / 36e5 % 24), {
                    total: t,
                ...
                s.innerHTML = i.days, u.innerHTML = ("0" + i.hours).slice(-2), l.innerHTML = ("0" + i.minutes).slice(-2), c.innerHTML = ("0" + i.seconds).slice(-2), i.total <= 0 && clearInterval(f)
            }
            n();
            var f = setInterval(n, 1e3)
        }("clockdiv", new Date(Date.parse(new Date) + 2725e6)), document.getElementById("icon-container").addEventListener("click", function() {
            ...
            e.on("scroll", function() {
                ...
                0 == e && t("#menu").removeClass("fixed-menu"), n < e ? t("#bottom-panel").addClass("hidden") : t("#bottom-panel").removeClass("hidden")
            })
        });
    var n = $(window),
        r = 0;
    n.on("scroll", function(e) {
        var t = n.scrollTop();
        t < r ? $("#menu").addClass("fixed-menu") : r < t && $("#menu").removeClass("fixed-menu"), r = t
    }), $(window).scroll(function() {
        $(".distrib h3").each(function() {
            $(this).offset().top < $(window).scrollTop() + $(window).innerHeight() && ($(this).addClass("animated fadeInUp"), $(".line-animation").addClass("loaded"))
        }), $(".distrib .status-separator").each(function() {
            $(this).offset().top < $(window).scrollTop() + $(window).innerHeight() && ($(this).addClass("animated fadeInUp"), $(".distrib .number").addClass("animated fadeInUp"), $(".distrib h5").addClass("animated fadeInUp"))
        })
    }), setTimeout(function() {
        $(".header-left").addClass("animated fadeInUp"), $(".ico-info").addClass("animated fadeInUp"), $(".menu").addClass("animated fadeInDown")
    }, 1e3);
    var t = 0;
    $(".menu-toogle-open").on("click", function(e) {
        $(".menu-toogle-open").toggleClass("toggled"), $(".mobile-menu-container").toggleClass("hidden"), 0 === t ? ($(".menu-toogle-open .burgx3").stop().transition({
            rotate: "45"
        }), $(".menu-toogle-open .burgx2").stop().transition({
            opacity: "0"
        }, "fast"), $(".menu-toogle-open .burgx").stop().transition({
            rotate: "-45"
        }), t++) : ($(".menu-toogle-open .burgx3").stop().transition({
            rotate: "+=135"
        ...
        var e, t, n;
        return $("#cForm").css("display", "block"), e = $("#inputName").val(), t = $("#inputEmail").val(), n = $("#textArea").val(), $.ajax({
            type: "POST",
            url: "php/mail.php",
            data: {
                email: t,
            ...
            cache: !1,
            success: function(e) {
                1 == e ? ($("#inputEmail").css("border-bottom", "1px solid #6e6868"), $("#loadBar").html("<p>Hello!<strong></strong> Your message was sent!</p>").fadeIn(4e3), $("#inputEmail").val(""), $("#inputName").val(""), $("#textArea").val("")) : ($("#loadBar").html(e).fadeIn(5e3), $("#loadBar").html(e).fadeOut(5e3), $("#inputEmail").css("border-bottom", "1px solid #f7153d"))
            }
        }), !1
